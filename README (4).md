...
1. Click **Connect** to start a Gemini Live session
2. Allow microphone (and optionally camera) access
3. Speak naturally — Meteo responds with audio and transcription
4. Click **⚙️ Configuration** (under the avatar) to change API key, model, or region without restarting
5. Upload a document (PDF / DOCX / TXT) to have Meteo tailor the session to your content
6. Click **⏺ Record** to capture the full session — mic + camera + Meteo audio — as a `.webm` file
